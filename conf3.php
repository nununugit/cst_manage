<?php
        ...
        $sql = "SELECT * FROM sort where done =0 AND group_gid=3";
...
<th bgcolor="#EE0000" width="150"><font color="#FFFFFF">チームid</font></th>
<th bgcolor="#EE0000" width="200"><font color="#FFFFFF">ボタン</font></th>
</tr>
...
<form action="conf3.php" method="POST">
